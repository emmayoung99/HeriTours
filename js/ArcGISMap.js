    ...
    function (esriConfig, Map, MapView, Graphic, GraphicsLayer, Locate, Home, ScaleBar, Compass, Legend, route, RouteParameters, FeatureSet, FeatureLayer, Expand) {
        ...
        const transitLabels = {
            symbol: {
                type: "text",
                /*color: "#FFFFFF",*/
                color: {expression:"return colors[$feature.LINE_NAME];"},
                haloColor: "white",
                haloSize: "0.5px",
                font: {
                    size: "6px",
        ...
        const map = new Map({
            ...
            layers: [transit, bike, trails, buildings],
        });
