...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-sm navbar-light bg-orange border-bottom box-shadow mb-3">
            <div class="container">
                <a class="navbar-brand" asp-area="" asp-page="Index.aspx">HeriTours</a>
    ...
    <div class="left-hst-text">
        <div class="content">
            <div class="text">
                ...
                <p>The City of Hamilton is situated upon the traditional territories of the Erie, Neutral, Huron-Wendat, Haudenosaunee and Mississaugas. This land is covered by the Dish With One Spoon Wampum Belt Covenant, which was an agreement between the Haudenosaunee and Anishinaabek to share and care for the resources around the Great Lakes. We further acknowledge that this land is covered by the Between the Lakes Purchase, 1792, between the Crown and the Mississaugas of the Credit First Nation.</p>
                <p>Today, the City of Hamilton is home to many Indigenous people from across Turtle Island (North America) and we recognize that we must do more to learn about the rich history of this land so that we can better understand our roles as residents, neighbours, partners, and caretakers.</p>
            </div>
            <%--<div class="image">
                <img src="/css/img/river_trprt.png" alt="Image">
            </div>--%>
        </div>
        </div>
        ...
        <div class="left-hst-text">
            ...
            Acquiring the land <strong><%= YearsAgo %> years ago</strong> in the area in 1815, Hamilton's vision and entrepreneurial spirit set the stage for the town's development. Collaborating with Nathaniel Hughson and implementing urban planning initiatives, Hamilton transformed the landscape, leading to the emergence of a vibrant urban center. With strategic infrastructure investments such as canals and railways, Hamilton's growth surged, cementing its status as a key industrial hub in Upper Canada.
            </p>
        </div>
